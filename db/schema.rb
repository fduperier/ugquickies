...
ActiveRecord::Schema.define(version: 20141212202102) do
  ...
  add_index "quickies", ["cached_votes_score"], name: "index_quickies_on_cached_votes_score"
  add_index "quickies", ["cached_votes_total"], name: "index_quickies_on_cached_votes_total"
  add_index "quickies", ["cached_votes_up"], name: "index_quickies_on_cached_votes_up"
  add_index "quickies", ["cached_weighted_average"], name: "index_quickies_on_cached_weighted_average"
