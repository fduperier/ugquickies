Shareable.configure do |config|
  ...
  #config.font=''
  config.colorscheme='light' # 'light' or 'dark'. '' defaults to 'light'.
  #config.ref=''
  config.share='false' # 'true' or 'false'. '' defaults to 'false'.
  config.kid_directed_site='false' # 'true' or 'false'. '' defaults to 'false'. Facebook assumes your site is not kid friendly.
  ...
  config.related='GenevaJUG' # related accounts
